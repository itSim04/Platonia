        ...
        case FOLLOW_SCHEMA::GET_FOLLOWERS:
            ...
            if (check_keys($_GET, USERS::ID)) {
                ...
                for ($i = 0; $i < count($output[RESPONSE::FOLLOWERS]); $i++) {
                    $output[RESPONSE::FOLLOWERS][$i]->profile_id = is_dir("../assets/users/{$output[RESPONSE::FOLLOWERS][$i]->user_id}/profiles") ? iterator_count(new FilesystemIterator("../assets/users/{$output[RESPONSE::FOLLOWERS][$i]->user_id}/profiles/", FilesystemIterator::SKIP_DOTS)) : 0;
                    $output[RESPONSE::FOLLOWERS][$i]->banner_id = is_dir("../assets/users/{$output[RESPONSE::FOLLOWERS][$i]->user_id}/banners") ? iterator_count(new FilesystemIterator("../assets/users/{$output[RESPONSE::FOLLOWERS][$i]->user_id}/banners/", FilesystemIterator::SKIP_DOTS)) : 0;
                }
        ...
        case FOLLOW_SCHEMA::GET_FOLLOWINGS:
            ...
            if (check_keys($_GET, USERS::ID)) {
                ...
                for ($i = 0; $i < count($output[RESPONSE::FOLLOWINGS]); $i++) {
                    $output[RESPONSE::FOLLOWINGS][$i]->profile_id = is_dir("../assets/users/{$output[RESPONSE::FOLLOWINGS][$i]->user_id}/profiles") ? iterator_count(new FilesystemIterator("../assets/users/{$output[RESPONSE::FOLLOWINGS][$i]->user_id}/profiles/", FilesystemIterator::SKIP_DOTS)) : 0;
                    $output[RESPONSE::FOLLOWINGS][$i]->banner_id = is_dir("../assets/users/{$output[RESPONSE::FOLLOWINGS][$i]->user_id}/banners") ? iterator_count(new FilesystemIterator("../assets/users/{$output[RESPONSE::FOLLOWINGS][$i]->user_id}/banners/", FilesystemIterator::SKIP_DOTS)) : 0;
                }
